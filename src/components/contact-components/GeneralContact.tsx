...
const GeneralContact: React.FC = () => {
  ...
  return (
    <div className="font-poppins text-[#000000] my-[30px] md:my-[50px] container mx-auto">
      ...
      <div className="flex flex-col lg:flex-row items-center md:items-start md:justify-center gap-[20%] mt-[50px]">
        <div className="flex flex-col md:flex-row lg:flex-col gap-[30px] max-w-[393px] ">
          <div className="flex gap-[20px]">
            ...
            <div>
              ...
              <p className="w-[212px] font-normal text-[14px] md:text-[16px]">
        ...
        <form
          className="flex flex-col gap-[15px] md:gap-[30px] mt-[25px] md:mt-0"
          onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col gap-[10px] md:gap-[15px] w-full md:w-[600px]">
          ...
          <div className="flex flex-col gap-[10px] md:gap-[15px]">
            ...
            <input
              ...
              className="rounded-[10px] border-[1px] border-customGray1 pt-[20px] pb-[60px] outline-none px-[14px] md:px-[20px] text-[14px] md:text-[16px]"
              {...register("message", {
                required: { value: true, message: "Required" },
